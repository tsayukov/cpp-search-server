...
public:
    ...
    explicit LogDuration(const std::string& operation_name, std::ostream& output_stream = std::cerr);
...
LogDuration::LogDuration(const std::string& operation_name, std::ostream& output_stream)
